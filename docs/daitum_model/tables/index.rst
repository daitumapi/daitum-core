...
- :doc:`derived_table` — grouped, sorted, filtered or pivoted view of a source table
- :doc:`joined_table` — rows produced by joining two or more tables
- :doc:`union_table` — rows stacked from multiple source tables, or a wide
  table's columns folded into rows
